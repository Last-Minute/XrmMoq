...
namespace TestPlugin2013.Tests
{
    ...
    public class ExamplePluginTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void Test_plugin_2013_preupdate_messagetype_execute()
        {
            //Arrange

            //Define the Target entity
            Entity target = new Entity("account") { Id = Guid.NewGuid() };
        ...
        /// </summary>
        [TestMethod]
        public void Test_plugin_2013_preupdate_messagetype_retrieve()
        {
            //Arrange
        ...
        [TestMethod]
        public void Test_plugin_2013_methodonly_trace_retrieve()
        {
            //Arrange
