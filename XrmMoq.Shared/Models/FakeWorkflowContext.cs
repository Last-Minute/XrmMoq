...
{
    /// <summary>
    /// Fake WorkflowContext used for testing or debugging.
    /// </summary>
    /// <seealso cref="Microsoft.Xrm.Sdk.Workflow.IWorkflowContext" />
    public class FakeWorkflowContext : IWorkflowContext
    {
        ...
        /// <summary>
        /// Gets a reference to the related <see langword="SdkMessageProcessingingStep" /> or <see langword="ServiceEndpoint" />.
        /// </summary>
        ...
        /// </summary>
        /// <value>True if this instance is executing offline; otherwise, false.</value>
        ...
        /// </summary>
        /// <value>The workflow category.</value>
        public int WorkflowCategory { get; set; } = 0; //Default to Workflow
        /// <summary>
        /// Indicates how the workflow is to be executed.
        /// </summary>
        /// <value>The workflow mode.</value>
